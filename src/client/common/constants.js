...
export const noTerminalBgValue = '[ðŸš«]'
export const textTerminalBgValue = '[ðŸ“]'
...
export const commonRxLineEndings = [
  ...
  { value: 'lf_to_crlf', label: 'LFâ†’CRLF' },
  { value: 'cr_to_crlf', label: 'CRâ†’CRLF' }
]
...
export const syncTokenCreateUrls = {
  ...
  cloud: 'https://sync.sarmaterm.org',
