...
[![license](https://img.shields.io/badge/license-MIT-blue.svg)](https://github.com/sarmaterm/sarmaterm/blob/master/LICENSE)
...
- [sarmaterm.org](https://sarmaterm.org): Homepage, downloads, videos, etc
...
- [sarmaterm online](https://cloud.sarmaterm.org): Public free online sarmaterm app
- [sarmaterm demo](https://demo.sarmaterm.org): Online demo of sarmaterm
- [sarmaterm AI](https://ai.sarmaterm.org): Free AI for sarmaterm users
- [sarmaterm deb repo](https://repos.sarmaterm.org/deb): Debian repo of sarmaterm
- [sarmaterm rpm repo](https://repos.sarmaterm.org/rpm): RPM repo of sarmaterm
...
- ðŸ‡ºðŸ‡¸ ðŸ‡¨ðŸ‡³ ðŸ‡§ðŸ‡· ðŸ‡·ðŸ‡º ðŸ‡ªðŸ‡¸ ðŸ‡«ðŸ‡· ðŸ‡¹ðŸ‡· ðŸ‡­ðŸ‡° ðŸ‡¯ðŸ‡µ ðŸ‡¸ðŸ‡¦ ðŸ‡©ðŸ‡ª ðŸ‡°ðŸ‡· ðŸ‡®ðŸ‡© ðŸ‡µðŸ‡± Multi-language support([sarmaterm-locales](https://github.com/sarmaterm/sarmaterm-locales), contributions/fixes welcome)
...
Check [https://repos.sarmaterm.org/deb](https://repos.sarmaterm.org/deb)
...
![sarmaterm-wechat-group-qr.jpg](https://sarmaterm.org/sarmaterm-wechat-group-qr.jpg)
...
[![wechat donate](https://sarmaterm.org/sarmaterm-wechat-donate.png)](https://github.com/sarmaterm)
...
- [https://sarmaterm.org/videos](https://sarmaterm.org/videos)
