 ...
 *
 * This is standard practice for AppImage â€” the format uses a volatile
...
function installDesktopFile () {
  ...
  // Icon source inside the AppImage (asar-aware path â€” Electron's fs
  // module transparently reads from inside app.asar)
  const srcIconPath = path.join(
    process.resourcesPath,
    'app.asar', 'assets', 'images', 'sarmaterm-round-128x128.png'
  )
